...
This inventory is normative for `0.1.2`. A field or destination not listed here must not be introduced without updating the privacy notice, threat model, tests, and release review.
